...
interface LightLinesProps {
    ...
    /** Line color */
    lineColor?: string;
    /** Use theme.css variables (--light-lines-*) so colors match html.dark without useTheme (avoids hydration mismatch) */
    usePortfolioTheme?: boolean;
...
export function LightLines({
    ...
    lightColor = "#fff",
    lineColor = "#fff",
    usePortfolioTheme = false,
    children,
}: LightLinesProps) {
    const lineFill = usePortfolioTheme ? "var(--light-lines-line)" : lineColor;
    const lightFill = usePortfolioTheme ? "var(--light-lines-light)" : lightColor;
    ...
    return (
        <div
            ...
            style={{
                background: usePortfolioTheme
                    ? "linear-gradient(180deg, var(--light-lines-from) 0%, var(--light-lines-to) 100%)"
        ...
        >
            ...
            >
                ...
                <g
                    ...
                    style={
                        usePortfolioTheme
                            ? { opacity: "var(--light-lines-lines-opacity)" }
                ...
                >
                    <rect
                        ...
                        width="4.5"
                        height="1080"
                        style={{ fill: lineFill, fillRule: "evenodd", clipRule: "evenodd" }}
                    />
                    <rect
                        className="line"
                        x="873.3"
                ...
                <g
                    ...
                    style={
                        usePortfolioTheme
                            ? { opacity: "var(--light-lines-lights-opacity)" }
                            : { opacity: lightsOpacity }
                    }
                >
                    <path
                        className="light1 light"
                        style={{ fill: lightFill, fillRule: "evenodd", clipRule: "evenodd" }}
